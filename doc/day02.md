...
* DIP (Dependency Inversion): Nuestra clase GiftShop() no depende de las implementaciones individuales de InvalidPattern(), sino que dependen directamente de la interfaz, por lo que ocurriría lo mismo que en la explicación anterior, si queremos cambiar algo no tenemos que cambiar nuestro código previo.